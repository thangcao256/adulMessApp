...
import com.thangcao.chatting.adapter.ChatAdapter;
import com.thangcao.chatting.models.ChatMessage;
import com.thangcao.chatting.models.User;
import com.thangcao.chatting.network.ApiClient;
import com.thangcao.chatting.network.ApiService;
...
//                showToast("Lỗi:"  + t.getMessage());
    ...
    private void sendMessage(){
        ...
        message.put(Constants.KEY_MESSAGE, inputMessage.getText().toString().trim());
